...
from app.state.repository import FileStateRepository, RunTransaction
...
class LifecycleStateMachine:
    ...
    def transition_run_in_transaction(
        ...
        *,
        ...
        """Transition a run while the caller holds its repository lock."""
    ...
    def transition_task_in_transaction(
        ...
        *,
        ...
        """Transition a task while the caller holds its repository lock."""
